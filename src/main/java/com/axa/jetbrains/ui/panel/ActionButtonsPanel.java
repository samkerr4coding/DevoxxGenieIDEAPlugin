...
import com.axa.jetbrains.controller.ActionButtonsPanelController;
import com.axa.jetbrains.controller.ProjectContextController;
...
import com.axa.jetbrains.ui.component.TokenUsageBar;
import com.axa.jetbrains.ui.component.input.PromptInputArea;
import com.axa.jetbrains.ui.listener.GlowingListener;
import com.axa.jetbrains.ui.listener.PromptSubmissionListener;
...
public class ActionButtonsPanel extends JPanel
    ...
    public ActionButtonsPanel(Project project,
        ...
        this.axaAiToolWindowContent = axaAiToolWindowContent;
    ...
    private void selectFilesForPromptContext(ActionEvent e) {
        ...
        if (addFileBtn.isShowing()) {
            new ContextPopupMenu().show(submitBtn,
                    popup,
                    axaAiToolWindowContent.getContentPanel().getSize().width,
